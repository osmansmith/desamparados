...
public class Iniciar_sesion extends AppCompatActivity {
    ...
    private void FirebaseGoogleAuth(GoogleSignInAccount acct) {
        ...
        if (acct != null) {
            ...
            mAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(Iniciar_sesion.this, "Successful", Toast.LENGTH_SHORT).show();
                        FirebaseUser user = mAuth.getCurrentUser();
                        updateUI(user);
                    } else {
                        Toast.makeText(Iniciar_sesion.this, "Failed", Toast.LENGTH_SHORT).show();
                        updateUI(null);
                    }
                }
            });
            ...
            Toast.makeText(Iniciar_sesion.this, "acc failed", Toast.LENGTH_SHORT).show();
        }
    }
